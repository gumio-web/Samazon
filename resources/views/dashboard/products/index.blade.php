...
<div class="w-75 mt-2">
    ...
    <div class="d-flex justify-content-between w-75 mt-4">
        <h3>合計{{$total_count}}件中{{$products->count()}}件</h3>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @else
                        <img src="{{ asset('img/dummy.jpg')}}" class="h-10 img-fluid">
                        @endif
                    </td>
                    <td>{{ $product->name }}</td>
                    <td>{{ $product->price }}</td>
                    ...
                    <td>
                        <a href="{{route('dashboard.products.edit', compact('product'))}}"
                    ...
                    <td>
                        ...
                        <form id="delete-form{{$product->id}}"
                            action="{{route('dashboard.products.destroy', compact('product'))}}" method="POST"
                            style="display: none;">
                            @csrf
    ...
    {{$products->appends(['sort' => $sorted])->links()}}
</div>
@endsection