    ...
    <main class="py-4 mb-5">
        ...
        <div class="d-flex justify-content-center">
            <div class="container w-50">
                ...
                @endif
                <form action="{{route('users.mypage.token')}}" method="post">
                    @csrf
                    @if (empty($card))
                    <!--
                        https://pay.jp/docs/checkout
                        クレジットカード番号を登録した際に、JavaScriptで何らかの処理をしたい場合はdata-on-created属性を指定する。
                        トークンの作成に成功した時にPAY.JPサーバからのレスポンスを引数に呼び出される関数を指定する。
                    -->
