    ...
    <div class="w-50">
        ...
        <div class="container">
            <div class="d-flex justify-content-between">
                ...
                <div class="d-flex align-items-center">
                    <a href="{{route('users.mypage.edit')}}">
        ...
        <div class="container">
            <div class="d-flex justify-content-between">
                ...
                <div class="d-flex align-items-center">
                    <a href="{{route('users.mypage.register_card')}}">
                        <i class="fas fa-chevron-right fa-2x"></i>
                    </a>
                </div>
            </div>
        ...
        <div class="container">
            <div class="d-flex justify-content-between">
                ...
                <div class="d-flex align-items-center">
                    <a href="{{route('users.mypage.cart_history')}}">
                        <i class="fas fa-chevron-right fa-2x"></i>
                    </a>
                </div>
            </div>
        ...
        <div class="container">
            <div class="d-flex justify-content-between">
                ...
                <div class="d-flex align-items-center">
                    <a href="{{route('users.mypage.edit_address')}}">
                        <i class="fas fa-chevron-right fa-2x"></i>
                    </a>
                </div>
            </div>
        ...
        <div class="container">
            <div class="d-flex justify-content-between">
                ...
                <div class="d-flex align-items-center">
                    <a href="{{ route('users.mypage.edit_password') }}">
                        <i class="fas fa-chevron-right fa-2x"></i>
                    </a>
                </div>
            </div>
