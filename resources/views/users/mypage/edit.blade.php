...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-5">
            <span>
                <a href="{{ route('users.mypage.index') }}">マイページ</a> > 会員情報の編集
            </span>
            ...
            <form method="POST" action="{{route('users.mypage.update')}}">
                ...
                <div class="form-group">
                    <div class="d-flex justify-content-between">
                        ...
                        <span onclick="switchEditUserInfo('.userName', '.editUserName', '.userNameEditLabel');"
                            class="userNameEditLabel user-edit-label">
                            編集
                        </span>
                    </div>
                ...
                <div class="form-group">
                    <div class="d-flex justify-content-between">
                        ...
                        <span onclick="switchEditUserInfo('.userMail', '.editUserMail', '.userMailEditLabel');"
                            class="userMailEditLabel user-edit-label">
                            編集
                        </span>
                    </div>
                ...
                <div class="form-group">
                    <div class="d-flex justify-content-between">
                        ...
                        <span onclick="switchEditUserInfo('.userPhone', '.editUserPhone', 'userPhoneEditLabel');"
                            class="userPhoneEditLabel user-edit-label">
                            編集
                        </span>
                    </div>
            ...
            <div class="d-flex justify-content-end">
                <!-- このdestroyのルーティングはresourceじゃなくて自分で設定したルートで、今回は追加のパラメータはいらないので設定しない。 -->
                <form method="POST" action="{{ route('users.mypage.destroy') }}">
                    @csrf
                    <input type="hidden" name="_method" value="DELETE">
                    <div class="btn dashboard-delete-link" data-toggle="modal" data-target="#delete-user-confirm-modal">
                        退会する</div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit"
                                        class="btn samazon-delete-submit-button text-white">退会する</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    // 第1引数textClassに入る.userName/.userMail/.userPhoneが設定されているdivは元々ブロック要素。
    //collapseは元々display: none; collapse showで表示になる。
