            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group">
                    <input id="password" type="password"
                        class="form-control @error('password') is-invalid @enderror samazon-login-input" name="password"
                ...
                <div class="form-group">
                    ...
                    <a class="btn btn-link mt-3 d-flex justify-content-center samazon-login-text"
