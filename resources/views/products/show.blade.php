...
<div class="d-flex justify-content-center">
    <div class="row w-75">
        ...
        <div class="col">
            ...
            @auth
            <form method="POST" action="{{route('users.carts.store')}}" class="m-3 align-items-end">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-5">
                        ...
                        <a href="{{route('products.favorite', compact('product'))}}"
                            class="btn samazon-favorite-button text-favorite w-100">
        ...
        <div class="offset-1 col-10">
            ...
            <div class="row">
                <div class="offset-md-5 col-md-5">
                    <form method="POST" action="{{route('products.reviews', compact('product'))}}">
                        @csrf
                        <h4>評価</h4>
                        <select name="score" class="form-controll m-2 review-score-color">
