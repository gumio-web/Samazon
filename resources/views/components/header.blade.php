<nav class="navbar navbar-expand-md navbar-light shadow-sm samazon-header-container">
    ...
    <form class="form-inline">
        ...
        <div class="input-group">
            <button type="submit" class="btn samazon-header-search-button">
                <i class="fas fa-search samazon-header-search-icon"></i>
            </button>
        </div>
    </form>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav ml-auto mr-5 mt-2">
            ...
            @else
            <li class="nav-item mr-5">
                <a class="nav-link" href="{{ route('users.mypage.index') }}">
                    <i class="fas fa-user mr-1"></i><label>マイページ</label>
                </a>
            </li>
            <li class="nav-item mr-5">
                <a class="nav-link" href="{{ route('users.mypage.favorite') }}">
                    <i class="far fa-heart"></i>
                </a>
            </li>
            <li class="nav-item mr-5">
                <a class="nav-link" href="{{ route('users.carts.index') }}">
